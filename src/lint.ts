...
const schemaById: Record<string, string> = {
  ...
  "bbb.dmx.groups.v1": "bbb.dmx.groups.v1.schema.json",
  "bbb.dmx.semantic_overrides.v1": "bbb.dmx.semantic_overrides.v1.schema.json",
  "bbb.dmx.setup.v1": "bbb.dmx.setup.v1.schema.json",
